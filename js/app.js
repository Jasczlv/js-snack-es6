...
let pesoBasso = parseInt(arrayBici[0].pesoInKg);
let biciPiuLeggera = arrayBici[0];

for (let i = 1; i < arrayBici.length; i++) {
  let pesoCorrente = parseInt(arrayBici[i].pesoInKg);
  if (pesoBasso > pesoCorrente) {
    pesoBasso = pesoCorrente;
    biciPiuLeggera = arrayBici[i];
  }
}
